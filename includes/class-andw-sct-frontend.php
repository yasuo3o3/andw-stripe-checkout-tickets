...
class Andw_Sct_Frontend {
    ...
    private function get_current_url() : string {
        $request_uri_raw = isset( $_SERVER['REQUEST_URI'] ) ? wp_unslash( $_SERVER['REQUEST_URI'] ) : ''; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- URL path requires protocol validation only.
